        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <?php endif ?>
                    <a href="<?= site_url('news/create'); ?>" class="btn btn-success mb-3">Add News</a>
                    ...
                    <tbody>
                        <?php foreach ($news as $newsArticle): ?>
                            <tr>
                                ...
                                <td><?= $newsArticle['name']; ?></td>
                                <td><?= $newsArticle['created_at']; ?></td>
                                <td><?= $newsArticle['visible']; ?></td>
                                <td>
                                    <button class="btn btn-primary edit-button" data-id="<?= $newsArticle['id'] ?>">Edit</button>
                                    <button class="btn btn-danger delete-button" data-id="<?= $newsArticle['id'] ?>">Delete</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click', '.edit-button', function () {
                    var id = $(this).data('id');
                    window.location.href = '<?= site_url('news/edit') ?>/' + id;
                });
