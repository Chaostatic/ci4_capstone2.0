...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <p>This page would be the Food page.</p>

            <p>It will include some information for some of the restaurants and food of Tanay, Rizal.</p>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
            <?php foreach ($thumbnails as $thumbnail): ?>
                <div class="col mb-4">
                    <a href="<?= site_url('foods/view/' . $thumbnail['id']) ?>">
                        <div class="card">
